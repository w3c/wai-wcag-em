...
*   completing and submitting the survey forms, and
...
*   include different functional components, such as date pickers, lightboxes, and sliders,
...
*   explaining settings, preferences, options, shortcuts, etc., and
